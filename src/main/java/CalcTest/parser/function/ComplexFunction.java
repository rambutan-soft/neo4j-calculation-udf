package CalcTest.parser.function;

import java.util.ArrayList;
import java.util.List;

import CalcTest.parser.ParserManager;
...
public class ComplexFunction {
    ...
    public Complex getValue(final List<Complex> values, final List<String> variables) throws CalculatorException {
        ...
        return eval(this.f, values, vars);
    }
     ...
     * @throws CalculatorException
     */
    private Complex eval(String f, final List<Complex> values, final List<String> variables) throws CalculatorException {
